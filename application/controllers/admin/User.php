...
class User extends MY_Controller
{
	...
	public function award_list()
	{
		...
		foreach ($award->result() as $r) {
			...
			$data[] = array(
				'<span data-toggle="tooltip" data-placement="top" title="' . $this->lang->line('xin_view') . '"><button type="button" class="btn icon-btn btn-xs btn-outline-info waves-effect waves-light" data-toggle="modal" data-target=".view-modal-data" data-award_id="' . $r->award_id . '"><span class="fa fa-eye"></span></button></span>',
				$emp_id,
				$full_name,
				$award_type,
				$r->gift_item,
	...
	public function assets_list()
	{
		...
		foreach ($assets->result() as $r) {
			...
			$data[] = array(
				'<span data-toggle="tooltip" data-placement="top" title="' . $this->lang->line('xin_view') . '"><button type="button" class="btn icon-btn btn-xs btn-outline-info waves-effect waves-light" data-toggle="modal" data-target=".view-modal-data" data-asset_id="' . $r->assets_id . '"><span class="fa fa-eye"></span></button></span>',
				$r->name,
				$category,
	...
	public function transfer_list()
	{
		...
		foreach ($transfer->result() as $r) {
			...
			$data[] = array(
				'<span data-toggle="tooltip" data-placement="top" title="' . $this->lang->line('xin_view') . '"><button type="button" class="btn icon-btn btn-xs btn-outline-info waves-effect waves-light" data-toggle="modal" data-target=".view-modal-data" data-transfer_id="' . $r->transfer_id . '"><span class="fa fa-eye"></span></button></span>',
				$employee_name,
				$transfer_date,
				$department_name,
				$location_name,
	...
	public function promotion_list()
	{
		...
		foreach ($promotion->result() as $r) {
			...
			$data[] = array(
				'<span data-toggle="tooltip" data-placement="top" title="' . $this->lang->line('xin_view') . '"><button type="button" class="btn icon-btn btn-xs btn-outline-info waves-effect waves-light" data-toggle="modal" data-target=".view-modal-data" data-promotion_id="' . $r->promotion_id . '"><span class="fa fa-eye"></span></button></span>',
				$employee_name,
				$r->title,
				$promotion_date,
				$full_name
		...
		foreach ($complaint->result() as $r) {
			...
			foreach ($aim as $dIds) {
				if ($session['user_id'] == $dIds) {
					...
					$data[] = array(
						'<span data-toggle="tooltip" data-placement="top" title="' . $this->lang->line('xin_view') . '"><button type="button" class="btn icon-btn btn-xs btn-outline-info waves-effect waves-light" data-toggle="modal" data-target=".view-modal-data" data-complaint_id="' . $r->complaint_id . '"><span class="fa fa-eye"></span></button></span>',
						$complaint_from,
						$ol,
						$r->title,
						$complaint_date,
	...
	public function warning_list()
	{
		...
		foreach ($warning->result() as $r) {
			...
			$data[] = array(
				'<span data-toggle="tooltip" data-placement="top" title="' . $this->lang->line('xin_view') . '"><button type="button" class="btn icon-btn btn-xs btn-outline-info waves-effect waves-light" data-toggle="modal" data-target=".view-modal-data" data-warning_id="' . $r->warning_id . '"><span class="fa fa-eye"></span></button></span>',
				$warning_date,
				$r->subject,
				$wtype,
				$status,
			...
			foreach ($aim as $dIds) {
				if ($session['user_id'] == $dIds) {
					...
					elseif ($r->training_status == 2):
						...
						$status = $this->lang->line('xin_terminated');
					endif;
		...
		foreach ($project->result() as $r) {
			...
			foreach ($aim as $dIds) {
				if ($session['user_id'] == $dIds) {
					...
					$data[] = array(
						'<span data-toggle="tooltip" data-placement="top" title="' . $this->lang->line('xin_edit') . '"><a href="' . site_url() . 'admin/user/project_details/' . $r->project_id . '"><button type="button" class="btn icon-btn btn-xs btn-outline-info waves-effect waves-light"><span class="fa fa-arrow-circle-right"></span></button></a></span>',
						$project_summary,
						$priority,
						$pdate,
						$pbar,
	...
	public function announcement_list()
	{
		...
		foreach ($announcement->result() as $r) {
			...
			$data[] = array(
				'<span data-toggle="tooltip" data-placement="top" title="' . $this->lang->line('xin_view') . '"><button type="button" class="btn icon-btn btn-xs btn-outline-info waves-effect waves-light" data-toggle="modal" data-target=".view-modal-data" data-announcement_id="' . $r->announcement_id . '"><span class="fa fa-eye"></span></button></span>',
				$r->title,
				$r->summary,
				$department_name,
				$sdate,
	...
	public function expense_list()
	{
		...
		foreach ($expense->result() as $r) {
			...
			if ($r->status == 0): $status = $this->lang->line('xin_pending');
			elseif ($r->status == 1):
				$status = $this->lang->line('xin_approved');
			else:
				$status = $this->lang->line('xin_cancel');
			endif;
	...
	public function add_expense()
	{
		...
		if ($this->input->post('add_type') == 'expense') {
			...
			/* Check if file uploaded..*/ else if ($_FILES['bill_copy']['size'] == 0) {
				$fname = 'no file';
			} else {
	...
	public function advance_salary_list()
	{
		...
		foreach ($advance_salary->result() as $r) {
			...
			if ($r->one_time_deduct == 1):
				$onetime = $this->lang->line('xin_yes');
			else:
				$onetime = $this->lang->line('xin_no');
			endif;
			// get company
			$company = $this->Xin_model->read_company_info($r->company_id);
			if (!is_null($company)) {
