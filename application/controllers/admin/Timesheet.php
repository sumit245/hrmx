...
class Timesheet extends MY_Controller
{
	...
	public function index()
	{
		...
		if (isset($month_year)):
			$title = date('F Y', strtotime($month_year));
		else:
			$title = date('F Y');
		endif;
	...
	public function holidays_list()
	{
		...
		foreach ($holidays->result() as $r) {
			...
			if ($r->is_publish == 1):
				$publish = '<span class="badge bg-green">' . $this->lang->line('xin_published') . '</span>';
			else:
				$publish = '<span class="badge bg-orange">' . $this->lang->line('xin_unpublished') . '</span>';
			endif;
	...
	public function leave_list()
	{
		...
		foreach ($leave->result() as $r) {
			...
			elseif ($r->status == 4):
				$status = '<span class="badge bg-green">' . $this->lang->line('xin_role_first_level_approved') . '</span>';
			else:
