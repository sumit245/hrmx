...
if (isset($_GET['jd']) && isset($_GET['is_ajax']) && $_GET['data'] == 'event') {
  ...
  <?php $hidden = array('user_id' => $session['user_id'], 'add_type' => 'travel'); ?>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control edate" placeholder="<?php echo $this->lang->line('xin_start_date'); ?>"
                    readonly name="start_date" type="text" id="start_date" value="<?php echo $_GET['event_date']; ?>">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control edate" placeholder="<?php echo $this->lang->line('xin_end_date'); ?>" readonly
                    name="end_date" type="text" id="end_date" value="<?php echo $_GET['event_date']; ?>">
                </div>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="<?php echo $this->lang->line('xin_expected_travel_budget'); ?>"
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <select class="select2" data-plugin="select_hrm"
                    data-placeholder="<?php echo $this->lang->line('xin_arragement_type'); ?>" name="arrangement_type">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="<?php echo $this->lang->line('xin_actual_travel_budget'); ?>"
